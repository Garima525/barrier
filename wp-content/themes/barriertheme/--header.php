...
<head>
    ...
    <link rel="preload" href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Spartan:ital,wght@0,400;0,500;0,600;0,700&family=Roboto+Slab:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" as="style" media="all" onload="this.onload=null;this.rel='stylesheet'" />
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Spartan:ital,wght@0,400;0,500;0,600;0,700&family=Roboto+Slab:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" media="all" />
    <link rel='stylesheet' id='wpo_min-header-0-css' href='<?php echo get_template_directory_uri().'/assets/css/wpo-minify-header-min.css'; ?>' type='text/css' media='all' />
    <link rel='stylesheet' id='wpo_min-header-0-css' href='<?php echo get_template_directory_uri().'/assets/css/wpo-minify-footer-min.css'; ?>' type='text/css' media='all' />
    <script   type='text/javascript' src="<?php echo get_template_directory_uri().'/assets/js/wpo-minify-header-min.js';?>" id='wpo_min-header-0-js'></script>


    <link rel="canonical" href="https://radiustheme.com/demo/wordpress/themes/neeon/home-08/" />
    <link rel='shortlink' href='https://radiustheme.com/demo/wordpress/themes/neeon/?p=6790' />
    <link rel="alternate" type="application/json+oembed" href="https://radiustheme.com/demo/wordpress/themes/neeon/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fradiustheme.com%2Fdemo%2Fwordpress%2Fthemes%2Fneeon%2Fhome-08%2F" />
    <link rel="alternate" type="text/xml+oembed" href="https://radiustheme.com/demo/wordpress/themes/neeon/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fradiustheme.com%2Fdemo%2Fwordpress%2Fthemes%2Fneeon%2Fhome-08%2F&#038;format=xml" />


    <link rel="icon" href="https://radiustheme.com/demo/wordpress/themes/neeon/wp-content/uploads/2021/12/cropped-favicon-32x32.png" sizes="32x32" />
    <link rel="icon" href="https://radiustheme.com/demo/wordpress/themes/neeon/wp-content/uploads/2021/12/cropped-favicon-192x192.png" sizes="192x192" />
    <link rel="apple-touch-icon" href="https://radiustheme.com/demo/wordpress/themes/neeon/wp-content/uploads/2021/12/cropped-favicon-180x180.png" />
    <meta name="msapplication-TileImage" content="https://radiustheme.com/demo/wordpress/themes/neeon/wp-content/uploads/2021/12/cropped-favicon-270x270.png" />
                        ...
                        <div class="menu-full-wrap">
                                    ...
                                    <div class="sidenav sidecanvas">
                                        <div class="canvas-content">
                                            ...
                                            <div class="additional-logo">
                                                <a class="dark-logo" href="https://radiustheme.com/demo/wordpress/themes/neeon/"><img width="162" height="52" src="https://radiustheme.com/demo/wordpress/themes/neeon/wp-content/uploads/2021/12/logo-dark.svg" class="attachment-full size-full" alt="" /></a>
                                                <a class="light-logo" href="https://radiustheme.com/demo/wordpress/themes/neeon/"><img width="159" height="50" src="https://radiustheme.com/demo/wordpress/themes/neeon/wp-content/uploads/2022/01/logo-light.svg" class="attachment-full size-full" alt="" /></a>
                                            </div>
                            ...
                            <div class="menu-wrap">
                                <div id="site-navigation" class="main-navigation">
                                    <?php wp_nav_menu( array( 'menu' => 'Main menus', 'container' => 'nav', 'container_class' => 'menu-main-menu-container' ) ); ?> 
                                </div>
                            </div>
                            <div class="header-icon-right">
                                <div class="header-search-six">
                                    <form role="search" method="get" action="https://radiustheme.com/demo/wordpress/themes/neeon/" class="search-form">
